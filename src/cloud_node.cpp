...
// pthread_t CalculationNode:: ssCreateThread(int pri, void * obj, PFUNC_THREAD fnth) {
//     pthread_t thrd_ ;
//     pthread_create(&thrd_, NULL, (void *(*)(void*))fnth, (void *)obj);
//     return thrd_ ;
//     }
...
// //     return thrd_ ;
// // }
// int CalculationNode::heartbeat_thread_run(void *para) {
//     printf("heart beat thread start \n");
//     // create socket, then read broadcast port2030 package
//     int client_fd;
//     int rtn;
...
// void CalculationNode::callback(rfans_driver_msg::FilterParamsConfig &config, uint32_t level){
